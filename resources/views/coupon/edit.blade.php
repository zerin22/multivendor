...
<div class="row">
    <div class="col-9 m-auto">
        <div class="content-header">
            <h2 class="content-title">Update Coupon</h2>
        </div>
    </div>
                            ...
                            <form  method="POST" action="{{ route('coupon.update', $coupon->id) }}" novalidate>
                                ...
                                <div class="row mb-4 ">
                                    ...
                                    <div class="col-lg-9 position-relative">
                                        <input type="text" name="coupon_name" class="form-control @error('coupon_name') is-invalid @enderror" value="{{ $coupon->coupon_name }}" placeholder="Type here" />
                                        @error('coupon_name')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        value="{{ $coupon->discount }}" placeholder="Type here" />
                                        @error('discount')
                                            <p class="text-danger font-weight-bold">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        value="{{ $coupon->validity }}" placeholder="Type here" />
                                        @error('validity')
                                            <p class="text-danger font-weight-bold">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        value="{{ $coupon->limit }}" placeholder="Type here" />
                                        @error('limit')
                                            <p class="text-danger font-weight-bold">{{ $message }}</p>
                                        @enderror
                                    </div>
